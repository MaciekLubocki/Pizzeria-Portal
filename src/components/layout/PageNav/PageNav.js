...
const PageNav = () => (
  ...
  <nav>
    ...
    <Button className={styles.link} component={NavLink} to={`${process.env.PUBLIC_URL}/waiterview`} activeClassName='active'>Waiter Menu</Button>
    <Button className={styles.link} component={NavLink} to={`${process.env.PUBLIC_URL}/kitchenview`} activeClassName='active'>Kitchen Menu</Button>
  </nav>
);
